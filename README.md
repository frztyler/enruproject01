...
<!-- 1.1.2 -->
## Практическое задание - Насколько мы все связаны?
...
Это вопрос с множественным выбором. После выбора варианта ответа нажмите кнопку "Отправить" ниже
...
Как называется устройство, которое способно засекать или измерять события или действия?
...
## Вопрос 2
Это вопрос с несколькими вариантами ответов. После выбора параметра нажмите кнопку "Отправить" ниже
...
В каком состоянии должны быть умные устройства, чтобы они могли изучать и изменять свой код на основе новых параметров?
